	          ...
	          <div class="modal-dialog modal-lg" role="document">
	            <div class="modal-content">
	              <div class="modal-header">
	                <h5 class="modal-title">Cadastrar usuário
	                </h5>
	                      ...
	                      <div class="row row-space">
	                        <div class="col-6">
	                          <div class="input-group">
	                            ...
	                            <input class="input--style-4" type="text" name="login" value="${user.login}">
	                          </div>
	                        </div>
	                        <div class="col-6">
	                          <div class="input-group">
	          ...
	          <tbody>
	            <c:forEach items="${users}" var="user">
	              <tr>
	                ...
	                <td>
	                  <a class="ml-3" href="manageUser?action=delete&id=${user.id}">
	                  	<img alt="Deletar" src="vendor/img/delete.png">
	                  </a>
	                </td>
	                <td>
	                  <a class="ml-2" href="manageUser?action=update&id=${user.id}">
	                  	<img alt="Editar" src="vendor/img/edit.png">
	                  </a>
	                </td>
	              </tr>
	            </c:forEach>
